        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
                <div class="navbar-nav text-center mx-auto">
                    ...
                    <a href="{{ route('progrrammes')}}" class="nav-item nav-link @if(Request::route()->getname() == 'programmes') active @endif wow fadeInDown" data-wow-delay="0.5s" onmouseover="this.style.color='#3C3882'" onmouseout="this.style.color=''">Programmes</a>
